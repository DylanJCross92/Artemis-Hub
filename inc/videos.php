        ...
        <?php
			...
			if($classes->have_posts()) 
			{
				while ($classes->have_posts()) : $classes->the_post(); 
					...
					$permalink = "?page=video&id=".$postID;//get_the_permalink();
					$category = get_field("exercise_type");
				?>
				
                	<li>   
                        <div class="left-col thumbnail-wrapper">
                            <a class="thumb-overlay" href="<?php echo $permalink?>"><div class="watch-button">Watch Exercise</div></a>
                            <img class="thumbnail" src="<?php echo $thumbnailURL?>"/>
                        </div>
                         
                        <div class="right-col info-wrapper">
                            <a class="title" href="<?php echo $permalink?>"><?php echo $title;?><!--<div class="new">New!</div>--></a>
